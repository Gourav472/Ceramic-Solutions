                ...
                <div className='max-lg:hidden flex flex-wrap flex-row -mx-3 pt-8'>
                    {WHAT_DO_CARDS.map((index) => (
                        <div key={index} className='px-3 mt-6 w-6/12 lg:w-4/12'>
                            <div className='p-6 rounded-3xl flex flex-col cursor-pointer border border-offBlack hover:border-transparent custom_duration min-h-[400px] xl:min-h-[470px] shadow-3xl '>
