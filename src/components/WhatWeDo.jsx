                ...
                <div className='max-lg:hidden flex flex-wrap flex-row -mx-3 pt-8'>
                    {WHAT_DO_CARDS.map((index) => (
                        <div key={index} className='px-3 mt-6 w-6/12 lg:w-4/12'>
                            <div className='p-6 rounded-3xl max-w-[364px] w-full flex flex-col cursor-pointer border border-offBlack hover:border-transparent custom_duration min-h-[400px] xl:min-h-[470px] shadow-3xl '>
                ...
                <div className='pt-[17px] mx-auto we_do_slider lg:hidden'>
                    <Slider {...settings_do}>
                        {WHAT_CARDS_SLIDER.map((index) => (
                            <div key={index} className='p-6 rounded-3xl flex flex-col cursor-pointer max-w-[342px] w-full border-offBlack custom_duration max-sm:min-h-[456px] sm:min-h-[400px] shadow-3xl '>
