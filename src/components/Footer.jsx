...
const Footer = () => {
    ...
    return (
        <div className='pt-16 pb-4'>
            <div className="container flex justify-center pb-11">
                <div className="flex flex-wrap flex-row justify-between -mx-3 w-full">
                    ...
                    {FOOTER_DATA.map((index) => (
                        <div key={index} className="max-w-[105px] w-full px-1 text-nowrap md:w-fit mt-6 lg:mt-0">
                    ...
                    <div className="lg:w-4/12 md:w-1/2 w-full px-3 mt-6 lg:mt-0">
                        ...
                        <div className="flex flex-col items-start gap-3 mt-4">
                            <a href="#hlo" className='font-jakarta font-normal text-base  capitalize text-primaryBlack'>Stay up to date</a>
                        </div>
                        <form method="get" className='flex items-center max-w-[340px] w-full mt-3 justify-between rounded-[62px] border-[#00000026] border-[1px] p-2.5'>
                            <input type="email" placeholder='Your email' className='w-7/12 pl-3' />
                            <CommonBtn ButtonName="Subscribe" ButtonClass="bg-red text-white" />
                        </form>
                    </div>
                </div>
            </div>
            ...
            <p className='text-center font-jakarta font-normal md:text-base text-sm capitalize text-primaryBlack'>Copyright {CURRENT_YEAR} ceramicsolutions.com all rights reserved</p>
        </div>
    )
}
