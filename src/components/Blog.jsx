...
const BlogCard = ({ imgSrc, title, link }) => (
    <div className="p-6 shadow-[0px_0px_12px_3px_lightGray] w-full h-full rounded-3xl hover:shadow-offRed custom_duration">
        ...
        <a href={link} className='flex items-center gap-2.5 mt-3 xl:mt-6 group'>
