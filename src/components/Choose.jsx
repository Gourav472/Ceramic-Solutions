      ...
      <div className="container">
        <div className="flex lg:flex-row flex-col sm:items-center">
          <div className="max-w-[590px] w-full">
            ...
            <CommonBtn ButtonName='Get a Quote' ButtonClass='text-white text-nowrap bg-red hover:bg-transparent border-[2px] hover:text-red max-w-[173px] lg:px-0 px-0 w-full h-[63px]' />
          </div>
